...
class SummaryConnector implements ConnectorInterface
{
    /**
     * @var Client
     */
    ...
    public function callApi(Stock $stock)
    {
        $result = $this->client->get(
            YahooFinance::API_BASE_URL . YahooFinance::STOCK_SUMMARY . $stock->ticker_symbol,
            [
                'headers' => [
